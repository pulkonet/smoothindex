...
export async function GET(request, { params }) {
    try {
        ...
        // Convert the clean URL back to sc-domain format
        const siteUrl = getOriginalSiteUrl(params.siteId);
